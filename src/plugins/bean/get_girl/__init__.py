...
DATA_PATH = f"{FILE_PATH}\\index.json"
...
def ReadLove():
    try:
        f = open(f'{FILE_PATH}\\love.json', 'r', encoding='utf8')
        f.close()
    except:
        f = open(f'{FILE_PATH}\\love.json', 'w+', encoding='utf8')
        f.close()


    try:
        f = open(f'{FILE_PATH}\\yandere.txt', 'r', encoding='utf-8')
        ...
        f = open(f'{FILE_PATH}\\yandere.txt', 'w+', encoding='utf-8')
        f.close()


    try:
        f = open(f'{FILE_PATH}\\marrytalk.txt', 'r', encoding='utf-8')
        a = f.readline().encode('utf-8').decode('utf-8')
        while a:
        ...
        f = open(f'{FILE_PATH}\\marrytalk.txt', 'w+', encoding='utf-8')
        f.close()
