...
async def _(bot: Bot, event: GroupMessageEvent, cost=0):
    ...
    await suanfa.send(MessageSegment.image(f"https://cdngoapl.twip.top/%E4%BA%91%E5%9B%BE/%E7%AE%97%E6%B3%95%E8%A1%A8.png"))


@rank.handle()
@is_level_A
async def _(bot: Bot, event: GroupMessageEvent, cost=0):
    await rank.send(MessageSegment.image(f"https://cdngoapl.twip.top/%E4%BA%91%E5%9B%BE/%E5%BC%BA%E5%BA%A6%E8%A1%A8.jpg"))
